...
public class SkyboxRenderer extends DrawRendererCommon {
	...
	public static SkyboxRenderer create(SkyboxShader skyboxShader, CameraEntity camera, CubeTexture skyboxTextureDay,
			CubeTexture skyboxTextureNight) {
		SkyboxRenderer renderer = new SkyboxRenderer(camera, skyboxTextureDay.getTextureId(),
				skyboxTextureNight.getTextureId());
		skyboxShader.start();
